...
const Contact = () => {
  return (
    <section className='mt-36 bg-[#dcc390]'>
      <motion.div
        initial='hidden'
        whileInView='visible'
      ...
      >
        ...
        <form className='w-full mt-16'>
          ...
          <div className='flex justify-center'>
            <button
              type='submit'
              className='mt-12 px-14 py-3 border border-gold text-center uppercase text-lg hover:bg-black hover:text-gold transition'
            >
              Send
            </button>
          </div>
